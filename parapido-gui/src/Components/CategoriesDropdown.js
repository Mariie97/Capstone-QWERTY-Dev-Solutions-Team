            ...
            <StyledEngineProvider injectFirst>
                <div>
                    ...
                    <div className="required-field-2-job-creation">
                        <hr className="category-error-job-creation" />
                        <hr className="category-1-error-job-creation" />
                        <hr className="city-error-2-job-creation" />
                        <hr className="category-3-error-job-creation" />
